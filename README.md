...
| whoj-backend-question-service | 8103 | 题目服务（题目管理、提交记录） |
| whoj-backend-judge-service | 8104 | 评测服务（代码执行、结果判定） |
| whoj-backend-post-service | 8105 | 帖子服务（论坛、评论、互动） |
| whoj-backend-validation-service | 8106 | 验证服务（邮箱验证码、Redis） |
